...
- [x] KAS-019 Add disposable-cluster integration suite for acquire/readiness/release/recreate. — completed 2026-09-20, commit: this KAS-019 commit; [live controller/Kata evidence](docs/evidence/kas-019-live-lifecycle.md); core controller installed; native readiness with secure-readiness withholding; `make verify`.
