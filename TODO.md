...
- [ ] AGD-005 Ensure one sandbox cannot authenticate as another SandboxBinding. — durable registry checkpoint implemented under ADR-0026; [database evidence](docs/evidence/agd-005-registry.md). Admission composition is implemented under ADR-0027 ([evidence](docs/evidence/agd-005-admission.md)); Secret operations and registered-publication checks are implemented under ADR-0028 ([evidence](docs/evidence/agd-005-bootstrap-secrets.md)); durable plan/UID/cleanup orchestration, credential loading, concrete policy adapters and rotation wiring remain.
