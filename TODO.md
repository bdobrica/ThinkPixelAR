...
- [x] AGD-004 Add certificate/token issuance/rotation or equivalent sandbox-scoped authentication mechanism. — completed 2026-09-21, this AGD-004 commit; ADR-0025, [credential evidence](docs/evidence/agd-004-credentials.md); dedicated client issuer, bounded bootstrap/fresh-key renewal, registration gating, race tests and `make verify`. Durable admission, Secret delivery/cleanup and rotation stream composition remain AGD-005.
