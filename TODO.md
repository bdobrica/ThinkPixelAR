...
- [x] KAS-013 Enforce/verify no service-account token, host namespaces, hostPath, privileged mode, container-runtime sockets, or unnecessary capabilities in the secure profile. — completed 2026-09-20, commit: this KAS-013 commit; [security evidence](docs/evidence/kas-013-security.md); `make verify`.
