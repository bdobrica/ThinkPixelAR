...
- [x] CDX-002 Build immutable Codex agent runtime OCI image containing required runtime dependencies and `thinkpixel-agentd`. — completed 2026-09-23; [ADR-0048](docs/adr/0048-codex-demo-runtime-image.md), [artifact digests, checks and limits](docs/evidence/cdx-002-codex-image.md). Combined amd64/ARM64 OCI artifact; amd64 protocol/tools/supervisor smoke and ARM64 emulation startup checks. Owner-approved local-demo license exception; model turns and native Kata execution remain subsequent CDX work.
