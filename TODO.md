...
- [ ] AGD-005 Ensure one sandbox cannot authenticate as another SandboxBinding. — durable registry checkpoint implemented under ADR-0026; [database evidence](docs/evidence/agd-005-registry.md). Remaining: trusted authority/provider admission, handshake/frame composition, Secret delivery/cleanup and rotation wiring.
