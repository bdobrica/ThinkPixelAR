...
- [ ] AGD-019 Commit Phase 4 with protocol/security evidence, including AGD-020 composition and AGD-013 rotation/reconnect. — next: [evidence/closure review](docs/phase-4-evidence.md), retaining the documented live qualification and recovery limitations.
