...
- [x] KAS-022 Verify resource requests/limits and ephemeral-storage boundaries are physically applied. — completed 2026-09-21, commit: this KAS-022 fix commit; [bounded scratch/compute evidence](docs/evidence/kas-022-bounded-resources.md), ADR-0020, race-enabled live lifecycle/suspend checks and `make verify`; scoped homelab substrate, not complete end-user admission.
...
- [ ] KAS-024 Commit Phase 3 with cluster manifests and evidence. — requires remaining provider capability/discovery validation and final evidence reconciliation; do not promote partial infrastructure evidence to complete secure-profile qualification.
