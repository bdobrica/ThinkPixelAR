...
- [x] KAS-003 Implement Runtime Profile configuration loader and validation. — completed 2026-09-20, commit: this KAS-003 commit, evidence: `make verify`; [profile evidence](docs/evidence/kas-003-profiles.md).
