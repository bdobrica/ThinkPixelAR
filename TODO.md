...
- [x] KAS-020 Add suspend/resume integration tests where supported by the pinned upstream release. — completed 2026-09-20, commit: this KAS-020 commit; [live native suspend/resume evidence](docs/evidence/kas-020-live-suspend-resume.md); race-enabled homelab suite and `make verify`.
